...
% Last Modified by GUIDE v2.5 25-Feb-2022 13:56:37
...
set(handles.pushbutton2,'background','green');
set(handles.pushbutton3,'background',[0.85,0.33,0.1]);
x=str2num(get(handles.n1,'string'))+str2num(get(handles.n2,'string'));
set(handles.sum,'string',x);
...
set(handles.pushbutton3,'background','green');
set(handles.pushbutton2,'background',[0.85,0.33,0.1]);
x=str2num(get(handles.n1,'string'))-str2num(get(handles.n2,'string'));
set(handles.sum,'string',x);
